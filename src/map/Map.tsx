...
import MapStage, { MapStageProps } from './MapStage';
  ...
  const handleMapInteraction = React.useCallback(
    (event: KonvaEventObject<TouchEvent | MouseEvent>) => {
      ...
      const position: [number, number] = [
        Math.floor((pointer.x - stage.x()) / stage.scaleX() + stage.offsetX()),
        Math.floor((pointer.y - stage.y()) / stage.scaleY() + stage.offsetY()),
      ];
